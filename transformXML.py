...
if __name__ == "__main__":
    ...
    xbrl=ss.makeXBRL()
    instance=ss.parseXML('XBRL_1111111111111_ep_nso_purcb_oper_nr_ex_mal_20231231.xml')
    ss.fillcontext(instance)
    ss.writecontext(xbrl)
    ss.makeUnit(xbrl)
    ss.writevarible(xbrl)
    ss.saveXBRL(xbrl,'XBRL_1111111111111_ep_nso_purcb_oper_nr_ex_mal_20231231_i')
